...
export default function Rangkuman({ auth }) {
    ...
    // State untuk menyimpan jenjang yang dipilih
    ...
    // Filter submateri berdasarkan jenjang yang dipilih
    const filteredSubmateri = submateriList.filter((submateri) =>
        selectedJenjangId ? submateri.id_jenjang === selectedJenjangId : true
    );
        ...
        <div className="flex flex-col min-h-screen bg-blue-100">
            ...
            <div className="flex-1 p-4 pt-32">
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 mb-6 mt-12">
                    ...
                    >
                        Pilih Jenjang ({selectedJenjangName})
                    </button>
                </div>

                {/* Kotak Rangkuman dengan Filter Jenjang */}
                <div className="flex flex-col gap-4 mt-6">
                    {filteredSubmateri.length > 0 ? (
                        ...
                        <p className="text-center text-gray-600">Tidak ada rangkuman untuk jenjang ini.</p>
                    )}
                </div>
            </div>
